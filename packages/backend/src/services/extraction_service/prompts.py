...
def _build_cluster_specs() -> None:
    ...
    _CLUSTER_SPECS["legal_scope"] = (
        ...
        (
            ...
            "7. DANGERS: extract an item ONLY when the chunk explicitly describes one of:\n"
            "   a. The company selling, renting, or sharing user personal data for money or equivalent value.\n"
            "   b. AI model training on user-generated content, messages, or personal data without an accessible opt-out.\n"
            "   c. Users personally liable for the company's legal costs beyond their own conduct (broad indemnification).\n"
            ...
            "   f. Collection of sensitive data (biometric, health, precise location, financial) without opt-out or explicit limits.\n"
            "   g. No self-service path to delete the account or personal data.\n"
            "   h. The company's unilateral right to make material changes to terms without advance notice or opt-out.\n"
            "   If the text does not clearly describe one of (a)–(h), do not extract it as a danger.\n"
            "   Use dispute_resolution for arbitration/class-action. Use termination_consequences for DMCA.\n"
            "   Use content_ownership for assignment clauses. Use liability for liability caps.\n"
            "   For each danger extracted, set materiality = material_risk.\n"
