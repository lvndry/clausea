...
def _build_cluster_specs() -> None:
    ...
    _CLUSTER_SPECS["legal_scope"] = (
        ...
        (
            ...
            "7. DANGERS: capture the atomic, materially-relevant facts about what the company is\n"
            "   permitted to do and what the user gives up. State each as a neutral, verifiable fact\n"
            "   with its evidence quote — do NOT editorialize or label it good or bad; the analysis\n"
            "   stage decides significance. Capture facts a reader analysing this policy would need,\n"
            "   such as:\n"
            "   - How personal data may be used, sold, rented, or shared, and with whom (including\n"
            "     parent/subsidiary/affiliate companies).\n"
            "   - AI training on user content or data, and whether an opt-out exists.\n"
            "   - What the user is liable for (indemnification).\n"
            "   - Licenses granted over user content (scope, duration, sublicensing).\n"
            "   - Billing terms: auto-renewal, refunds, cancellation conditions.\n"
            "   - Sensitive data collected (biometric, health, precise location, financial, children's)\n"
            "     and any stated limits.\n"
            "   - Account/data deletion mechanisms, or their absence.\n"
            "   - Powers the company reserves: changing terms, suspending, blocking, removing content,\n"
            "     and on what conditions.\n"
            "   - Consequences reaching beyond the service (offline conduct, other apps, estate/heirs).\n"
            "   Capture standard terms too when materially relevant; the analysis stage filters routine\n"
            "   boilerplate. Use dispute_resolution for arbitration/class-action, termination_consequences\n"
            "   for DMCA, content_ownership for assignment clauses, liability for liability caps.\n"
