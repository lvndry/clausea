...
_REDIRECT_QUERY_KEYS = frozenset(
    {
        "return_to", "returnto", "return", "redirect", "redirect_to",
        "redirect_uri", "redir", "next", "url", "continue", "dest",
        "destination", "goto", "go", "ref_url", "callback", "came_from", "origin",
    }
)
_LANGUAGE_CODES = frozenset(
    {
        "ar", "bg", "cs", "da", "de", "el", "en", "es", "et", "fa", "fi", "fr",
        "he", "hi", "hu", "id", "it", "ja", "ko", "lt", "lv", "ms", "nl", "no",
        "pl", "pt", "ro", "ru", "sk", "sl", "sv", "th", "tr", "vi", "zh",
    }
)
_LANGUAGE_NAMES = frozenset(
    {
        ...
        "japanese", "koreana", "korean", "norwegian", "polish", "portuguese",
        "romanian", "russian", "schinese", "tchinese", "spanish", "swedish",
...
_TRACKING_QUERY_PARAMS = frozenset(
    {
        ...
        "twclid", "ttclid", "igshid", "li_fat_id", "rdt_cid", "_ga", "_gl",
        "mc_cid", "mc_eid", "mkt_tok", "_hsenc", "_hsmi", "vero_id",
        "vero_conv", "oly_anon_id", "oly_enc_id", "ef_id", "s_kwcid", "rel",
    }
)
